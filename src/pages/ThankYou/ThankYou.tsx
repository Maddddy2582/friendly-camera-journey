        ...
        <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 shadow-2xl border border-white/20 transform hover:scale-105 transition-all duration-300">
          ...
          <div className="space-y-4 text-center">
            <p className="text-gray-200 text-lg leading-relaxed">
              Our mystical journey through your palm lines has been
              enlightening. Thank you for sharing your energy with us today.
            </p>

            <p className="text-amber-300/80 italic">
              "The lines on your palm tell stories of yesterday, guide you
              today, and illuminate tomorrow."
            </p>
          </div>
